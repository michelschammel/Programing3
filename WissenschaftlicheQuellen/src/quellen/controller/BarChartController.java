...
public class BarChartController {
		String[] DatabaseTypes = {"Anderes", "Artikel", "B�cher", "Onlinequellen", "Quellen", "Tags", "TagsZitate",
	    ...
	    private void setStats1() {
	    	try {
	    		...
	    		String[] types = {"Anderes", "Artikel", "B�cher", "Onlinequellen", "Quellen", "Tags", "TagsZitate",
	    				"W. Arbeiten", "Zitate"};
